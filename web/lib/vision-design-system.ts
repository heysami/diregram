...
export function buildVisionDesignSystemReadout(spec: VisionDesignSystemV1): string {
  ...
  lines.push(`- typography.baseWeight: ${ds.controls.typography.baseWeight}`);
  lines.push(`- typography.sizeGrowth: ${ds.controls.typography.sizeGrowth}`);
  lines.push(`- typography.weightGrowth: ${ds.controls.typography.weightGrowth}`);
  lines.push(`- typography.contrast: ${ds.controls.typography.contrast}`);
  lines.push(`- spacing.pattern: ${ds.controls.spacing.pattern}`);
  lines.push(`- spacing.density: ${ds.controls.spacing.density}`);
  lines.push(`- spacing.aroundVsInside: ${ds.controls.spacing.aroundVsInside}`);
  lines.push(`- flatness: ${ds.controls.flatness}`);
  lines.push(`- zoning: ${ds.controls.zoning}`);
  lines.push(`- softness: ${ds.controls.softness}`);
  lines.push(`- surfaceSaturation: ${ds.controls.surfaceSaturation}`);
  lines.push(`- itemSaturation: ${ds.controls.itemSaturation}`);
  lines.push(`- colorVariance: ${ds.controls.colorVariance}`);
  lines.push(`- colorBleed: ${ds.controls.colorBleed}`);
  lines.push(`- colorBleedTone: ${ds.controls.colorBleedTone}`);
  lines.push(`- colorBleedText: ${ds.controls.colorBleedText}`);
  lines.push(`- wireframeFeeling: ${ds.controls.wireframeFeeling}`);
  lines.push(`- visualRange: ${ds.controls.visualRange}`);
  lines.push(`- skeuomorphism: ${ds.controls.skeuomorphism}`);
  lines.push(`- skeuomorphismStyle: ${ds.controls.skeuomorphismStyle}`);
  lines.push(`- negativeZoneStyle: ${ds.controls.negativeZoneStyle}`);
  lines.push(`- boldness: ${ds.controls.boldness}`);
  lines.push(`- boldTypographyStyle: ${ds.controls.boldTypographyStyle}`);
  lines.push(`- boldGradientSource: ${ds.controls.boldGradientSource}`);
